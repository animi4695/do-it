...
var task_card_string = "<div style='cursor: pointer' class=\"status-icon\"></div><p class=\"task-text\"><p class=\"task-status color-red\">Not-Started</p><ion-icon class=\"delete fs-large mg-10\" name=\"close-circle-outline\"></ion-icon>"
var task_count = 0;
updateTaskCount();
eventSetter();
